...
=====================================================================================
||                       ||    '''+blue+''' _   _ _       _   _                                ||
||                       ||    '''+purple+'''| | | (_)     | | | |___  ___ _ __                  ||
||1. Figlet              ||    '''+cyan+'''| |_| | |_____| | | / __|/ _ \ '__|                 ||
||                       ||    '''+green+'''|  _  | |_____| |_| \__ \  __/ |                    ||
||                       ||    '''+red+'''|_| |_|_|      \___/|___/\___|_|                    ||
||                       ||    '''+yellow+'''                                                    ||
=====================================================================================
||                       ||    '''+blue+'''                                                    ||
||                       ||    '''+purple+''' m    m   "           m    m                        ||
||                       ||    '''+cyan+''' #    # mmm           #    #  mmm    mmm    m mm    ||
||2. Toilet              ||    '''+green+''' #mmmm#   #           #    # #   "  #"  #   #"      ||
||                       ||    '''+red+''' #    #   #     """   #    #  """m  #""""   #       ||
||                       ||    '''+yellow+''' #    # mm#mm         "mmmm" "mmm"  "#mm"   #       ||
||                       ||                                                        ||
=====================================================================================
||                       ||   '''+blue+'''  _    _ _   _    _                                  ||
||                       ||   '''+purple+''' | |  | (_) | |  | |                                 ||
||                       ||   '''+cyan+''' | |__| |_  | |  | |___  ___ _ __                    ||
||3. WebSite             ||   '''+green+''' |  __  | | | |  | / __|/ _ \ '__|                   ||
||                       ||   '''+red+''' | |  | | | | |__| \__ \  __/ |                      ||
||                       ||   '''+yellow+''' |_|  |_|_|  \____/|___/\___|_|                      ||
||                       ||                                                        ||
=====================================================================================  
